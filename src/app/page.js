  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
        <h1 className="text-4xl font-bold">Influencer Equity Agreement Platform</h1>
      </div>
      ...
      <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-2 lg:text-left">
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-sm opacity-50">Login to your IEAP account</p>
        </Link>
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-sm opacity-50">Create a new IEAP account</p>
        </Link>
      </div>
    </main>
  )
