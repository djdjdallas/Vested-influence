  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data) {
        ...
        // This would typically happen in a serverless function or backend
        // For now, we'll simulate it by redirecting to dashboard
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            >
              ...
              <option value="influencer">Content Creator or Influencer</option>
